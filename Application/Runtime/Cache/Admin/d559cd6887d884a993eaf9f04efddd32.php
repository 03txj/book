...
<header class="am-topbar admin-header">
	...
	<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
		<ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
			...
			<li><a href="/book/index.php?s=/Admin/extend/pickers.html"><span class="am-icon-user"></span> 后台首页</a></li>
		...
		<table class="am-table am-table-striped am-table-hover table-main">
			<thead>
			 <tr>
					...
					<th class="table-author">节点</th>
					<th class="table-date am-hide-sm-only">入库时间</th>
				</tr>
			</thead>
			<?php if(is_array($pickerlist)): foreach($pickerlist as $key=>$vo): ?><tr>
				<td class="am-hide-sm-only"><?php echo ($vo["id"]); ?></td>
				<td><?php echo ($vo["title"]); ?></td>
				<td><?php echo ($vo["url"]); ?></td>
				<td><?php echo ($vo["pid"]); ?></td>
				<td class="am-hide-sm-only"><?php echo (date('Y-m-d H:i',$vo["updatetime"])); ?></td>
