...
<header class="am-topbar admin-header">
	...
	<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
		<ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
			...
			<li><a href="/book/index.php?s=/Admin/extend/searchlog.html"><span class="am-icon-user"></span> 后台首页</a></li>
...
<div class="am-cf admin-main">
	...
	<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">搜素记录</strong></div>
</div>
<hr>
...
<div class="am-g">
	<div class="am-u-sm-12">
		<table class="am-table am-table-striped am-table-hover table-main">
			<thead>
			 <tr>
					<th class="table-id am-hide-sm-only am-hide-sm-only">ID</th>
					<th class="table-title">搜索词</th>
					<th class="table-type">次数</th>
					<th class="table-author">结果</th>
					<th class="table-author">IP</th>
					<th class="table-date am-hide-sm-only">搜索时间</th>
				</tr>
			</thead>
			<?php if(is_array($searchloglist)): foreach($searchloglist as $key=>$vo): ?><tr>
				<td class="am-hide-sm-only"><?php echo ($vo["id"]); ?></td>
				<td><?php echo ($vo["searchword"]); ?></td>
				<td><?php echo ($vo["num"]); ?></td>
				<td><?php if($vo['hasresult'] > 0): ?><font color=green>有</font><?php else: ?><font color=red>无</font><?php endif; ?></td>
				<td class="am-hide-sm-only"><?php echo ($vo["ip"]); ?></td>
				<td class="am-hide-sm-only"><?php echo (date('Y-m-d H:i',$vo["dateline"])); ?></td>
