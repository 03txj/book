...
<title>后台登录</title> 
<link href="/book/Public/css/login_v1.css" type="text/css" rel="stylesheet">
<script>
function checklogin(){
...
<div class="login">
	...
	<form action="/book/index.php?s=/Admin/Index/login" method="post" onsubmit="return checklogin();">
